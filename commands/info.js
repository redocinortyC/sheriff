  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("about")
        .setDescription(
          "What is the International Junior Honor Society (or IJHS)?"
        )
    )
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("slc")
        .setDescription(
          "What is the IJHS Student Leadership Council (or IJHS SLC)?"
        )
    ),
